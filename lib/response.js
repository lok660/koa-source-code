...
//  解析响应 content-disposition
const contentDisposition = require('content-disposition');
//  获取响应的 content-type
const getType = require('cache-content-type');
//  请求关闭时,完成或者出错调用注册好的回调
...
/**
 *  在application.js中的createContext函数中,会把node原生的res作为response对象(即response.js封装的对象)的属性
 *  response对象会基于req封装很多便利的属性和方法,供处理请求时调用
